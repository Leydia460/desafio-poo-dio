public class Main {
    public static void main(String[] args) {
...
}# Criado por https://www.toptal.com/developers/gitignore/api/java,intellij,eclipse,visualstudiocode
        # Edite em https://www.toptal.com/developers/gitignore?templates=java,intellij,eclipse,visualstudiocode
        ...
        *.lançar
        ...
        # PyDev específico (Python IDE para Eclipse)
        *.pydevproject

        # Específico do CDT (ferramentas de desenvolvimento C/C++)
        .cprojeto

        # CDT- ferramentas automáticas
        .autotools

        # Processador de anotações Java (APT)
        .factorypath
        ...
        # Descomente esta linha se desejar ignorar o arquivo de descrição do projeto.
        # Normalmente, este arquivo seria rastreado se contiver configurações de compilação/dependência:
        #.projeto

        ### Atualização do Eclipse ###
        # Ferramentas de inicialização do Spring
        .sts4-cache/
...
cmake-build-*/
        ...
        *.rar
        ...
        # logs de travamento da máquina virtual, consulte http://www.java.com/en/download/help/error_hotspot.xml
        hs_err_pid*
        replay_pid*
...
# Fim de https://www.toptal.com/developers/gitignore/api/java,intellij,eclipse,visualstudiocode# Criado por https://www.toptal.com/developers/gitignore/api/java,intellij,eclipse,visualstudiocode
# Edite em https://www.toptal.com/developers/gitignore?templates=java,intellij,eclipse,visualstudiocode
...
# Fim de https://www.toptal.com/developers/gitignore/api/java,intellij,eclipse,visualstudiocode